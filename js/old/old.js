function TimeLine(options) {
	...
	my.initGraph = function(margin, height, width, xAxis, yAxis, data){
        ...
        var area = d3.svg.area()
            ...
            .x(function(d) { return my.x()(d.date); })
            .y0(my.height())
            .y1(function(d) { return my.y()(d.close); });
        my.area(area);
	...
	my.initRect = function (container, width, height, margin) {
        ...
        var area = d3.svg.area()
            .interpolate("monotone")
            .x(function(d) { return my.brushX()(d.date); })
            .y0(my.brushHeight())
            .y1(function(d) { return my.brushY()(d.close); });
        my.brushArea(area);
        my.initContext(area);
    };
	...
	my.zoomIn = function() {
		...
		my.updateArgsRect(my.width() - 20, my.height() - 20, my.margin());
	}
